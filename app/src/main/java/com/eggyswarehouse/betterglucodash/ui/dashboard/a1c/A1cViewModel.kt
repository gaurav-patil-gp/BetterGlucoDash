 ...
 * all calculation to [A1cCalculator]. The ADAG formula requires a 60-day minimum;
 * the extra 30 days provides a larger sample for improved accuracy once funded.
 *
...
class A1cViewModel(private val repository: LibreRepository) : ViewModel() {
    ...
    private val NINETY_DAYS_HOURS = 90 * 24

    val uiState: StateFlow<A1cState> = repository
